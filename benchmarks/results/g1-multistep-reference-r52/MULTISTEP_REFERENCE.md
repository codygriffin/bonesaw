...
- Rust analytic sampling: `0.546 ms` total, `0` allocations / `0` B.
- Complete reference bitwise repeat: `True` (`0c78317ad7cfdfec6f72d98f29b8aed2d6ca5dc52f58f0ba9946b7232871538e`).

## Per-step plan

| step | swing | global liftoff | global touchdown | first / second CoP margin | applied landing x | retargeted |
|---:|---:|---:|---:|---:|---:|---:|
| 0 | left | 300 | 529 | 22.88 / 21.39 mm | 0.036 m | False |
| 1 | right | 879 | 1108 | 7.27 / 7.27 mm | 0.098 m | False |
| 2 | left | 1458 | 1687 | 7.27 / 7.27 mm | 0.160 m | False |
| 3 | right | 2037 | 2266 | 7.27 / 7.27 mm | 0.222 m | False |
