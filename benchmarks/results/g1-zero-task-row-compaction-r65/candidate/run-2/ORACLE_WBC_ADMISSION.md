...
|---|---:|---:|---:|---:|---:|---:|
| Rust whole-body IK witness | 2317/2317 converged | foot 4.04 mm · CoM 29.20 mm | 17.7 µs | 22.0 µs | 71.1 µs | 0 calls / 0 B |
| Rust analytic jet projection | authored residual: foot v 0.62% · a 0.75% · CoM v 34.68% · a 35.21% | analytic Jv / Jq̈+J̇v | 27.7 µs | 32.6 µs | 62.8 µs | 0 calls / 0 B |
| Stateless floating WBC | 2317/2317 solved | dynamics 1.71e-09 · contact 6.66e-11 · CoP margin 0.500 cm | 3338.4 µs | 5704.2 µs | 9094.1 µs | 0 calls / 0 B |
...
Across contact edges, the maximum authored position / velocity / acceleration deltas are `0.000 mm` / `0.000163 m/s` / `0.064606 m/s²`. Every edge window solves without infeasible/failed status; maximum dynamics/contact residual is `1.10e-09` / `4.16e-11`, minimum CoP margin is `5.000 mm`, peak actuator utilization is `38.35%`, and maximum WBC time is `7.328 ms`.

| tick | edge | foot | WBC solved | hard dynamics / contact | CoP margin | actuator use | max time | clipped ticks |
|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 300 | liftoff | 0 | 17/17 | 5.52e-10 / 3.63e-11 | 5.14 mm | 35.89% | 7.328 ms | 8 |
| 529 | touchdown | 0 | 17/17 | 4.14e-10 / 1.46e-11 | 5.00 mm | 38.35% | 5.646 ms | 12 |
| 879 | liftoff | 1 | 17/17 | 8.87e-10 / 3.37e-11 | 5.00 mm | 32.64% | 3.710 ms | 8 |
| 1108 | touchdown | 1 | 17/17 | 7.71e-10 / 4.16e-11 | 5.00 mm | 33.49% | 4.107 ms | 9 |
| 1458 | liftoff | 0 | 17/17 | 4.95e-10 / 1.39e-11 | 5.00 mm | 28.59% | 4.291 ms | 14 |
| 1687 | touchdown | 0 | 17/17 | 5.99e-10 / 1.67e-11 | 5.00 mm | 29.06% | 3.958 ms | 13 |
| 2037 | liftoff | 1 | 17/17 | 1.10e-09 / 3.16e-11 | 5.00 mm | 23.52% | 3.578 ms | 13 |
| 2266 | touchdown | 1 | 17/17 | 3.82e-10 / 2.89e-11 | 6.23 mm | 24.19% | 3.300 ms | 9 |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0 | 530 | 249 / 281 | 281 | 0.002 / 0.217 / 0.001 | 0.201 / 0.001 | 1.46e-09 / 5.37e-11 | 5.00 mm | 43.6% | 3.334 / 6.043 / 7.555 ms |
| 1 | 1 | 579 | 256 / 323 | 323 | 0.000 / 0.538 / 0.000 | 0.624 / 0.001 | 1.50e-09 / 6.66e-11 | 5.00 mm | 53.1% | 3.464 / 5.867 / 9.094 ms |
| 2 | 0 | 579 | 164 / 415 | 415 | 0.001 / 0.637 / 0.000 | 0.694 / 0.001 | 1.71e-09 / 6.08e-11 | 5.00 mm | 47.0% | 3.400 / 5.321 / 6.685 ms |
| 3 | 1 | 579 | 201 / 378 | 378 | 0.000 / 0.697 / 0.001 | 0.811 / 0.001 | 1.30e-09 / 4.56e-11 | 5.00 mm | 51.4% | 3.276 / 5.238 / 6.081 ms |
...
| Compute · Rust WBC wall time | p99 5704.2 µs · max 9094.1 µs | 4000 / 5000 µs | 51 tick |
