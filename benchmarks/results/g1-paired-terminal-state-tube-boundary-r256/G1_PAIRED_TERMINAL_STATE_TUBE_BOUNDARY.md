...
A fixed 3-candidate × 4-hypothesis G1-shaped batch repeats 500 times at p50/p99 378.45/402.02 µs with zero measured Rust allocation. All 384 independently sampled paired points are contained; minimum slack is 0. The baseline is exactly zero by construction.
