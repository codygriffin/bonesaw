...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 160 | 0.800 s | 4.343 cm | 0.103 cm | 0.639 cm | 25.957 cm | 0.921° | 8.000 rad/s | 10152.2 µs |
...
|---|---:|
| root RMS | 4.343 cm |
| stance foot RMS | 0.103 cm |
| swing foot RMS | 0.639 cm |
| hand RMS | 25.957 cm |
| maximum root rotation | 0.921° |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 160 | 0.8 s | 2458.1 µs | 9332.6 µs | 10152.2 µs | 10275.4 µs | 53 | 64 | 40 | 3 | 0 | 0 | 0 | 0 |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 3466.9 | 2368.0 | 218.3 | 8969.2 | 10266.1 | 10274.5 | 3110.5 | 160 | 22 | 0 | 288.4 |

### Latency by solver/contact status

| status | ticks | p50 µs | p95 µs | p99 µs | max µs |
|---|---:|---:|---:|---:|---:|
| solved | 53 | 2443.2 | 2492.5 | 2510.5 | 2518.7 |
| solved_with_slack | 64 | 3710.0 | 9914.1 | 10238.4 | 10275.4 |
| touchdown_transition | 3 | 2546.1 | 2636.6 | 2644.7 | 2646.7 |
| precontact_transition | 40 | 2053.6 | 2392.3 | 2464.0 | 2502.9 |
...
|---:|---:|---:|---:|---:|---:|---:|---:|
| 6.86 | 12.0 | 14.8 | 23 | 3.94 | 13.2 | 21 | 0.2737 |

The feasibility seed is a cyclic hard-halfspace projection before semantic task solving. Near-feasible seeds may then enter a dense active-set polish; these counters make that previously hidden work visible without timing inside the solver.

| projection sweeps mean/p95/p99/max | halfspace projections mean/p95/p99/max | polish iterations mean/p99/max | polish pseudoinverses mean/p99/max | polish Jacobi sweeps mean/p99/max | projections↔latency correlation |
|---:|---:|---:|---:|---:|---:|
| 31.33/234.0/236.0/236 | 7328.40/54756.0/55224.0/55224 | 0.14/1.0/1 | 0.14/1.0/1 | 1.19/9.0/9 | 0.9700 |

| status | ticks | pseudoinverse mean/p99/max | clipped-step mean/p99/max |
|---|---:|---:|---:|
| solved | 53 | 4.00/4.0/4 | 0.00/0.0/0 |
| solved_with_slack | 64 | 8.56/18.6/23 | 6.97/17.2/21 |
| touchdown_transition | 3 | 9.33/12.9/13 | 6.67/10.9/11 |
| precontact_transition | 40 | 7.75/10.6/11 | 4.10/7.0/7 |

| priority | pseudoinverse mean/p99/max | Jacobi sweeps mean/p99/max | clipped-step mean/p99/max | ticks clipped |
|---|---:|---:|---:|---:|
| invariant | 1.45/6.0/7 | 5.47/24.0/28 | 0.57/5.4/7 | 38 |
| viability | 0.27/1.0/1 | 1.31/5.0/5 | 0.00/0.0/0 | 0 |
| intent | 1.80/6.8/8 | 3.62/13.6/16 | 1.27/6.8/8 | 76 |
| preference | 2.23/10.0/18 | 15.04/66.5/119 | 1.86/10.0/17 | 106 |
| style | 1.12/2.0/3 | 11.50/23.0/33 | 0.24/2.0/2 | 32 |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0.555 | 0.555 | 0.555 | 1.000 | 1.000 | 41.555 | 41.785 | 0.230 | 41.785 | 0.001 | 0 | 58 | 0 | 0 | 1 |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0–15 | 2448.0 | 2500.0 | 4.00 | 23.62 | 0.00 | 1.00 | 234.00 | 0.000 | 0.000 | 1.21e-09 | 3.03e-11 | 0 |
| 16–31 | 2443.0 | 2478.0 | 4.00 | 23.81 | 0.00 | 1.00 | 234.00 | 0.000 | 0.000 | 1.21e-09 | 3.03e-11 | 0 |
| 32–47 | 2437.8 | 2514.9 | 4.00 | 23.75 | 0.00 | 1.00 | 234.00 | 0.000 | 0.000 | 1.21e-09 | 3.03e-11 | 0 |
| 48–63 | 2361.5 | 2489.1 | 6.81 | 39.00 | 2.94 | 1.00 | 225.75 | 0.000 | 0.176 | 1.21e-09 | 3.03e-11 | 11 |
| 64–79 | 2110.8 | 2478.8 | 7.62 | 43.88 | 3.62 | 1.00 | 222.00 | 0.001 | 0.635 | 1.01e-09 | 9.22e-12 | 16 |
| 80–95 | 1924.7 | 2631.6 | 7.94 | 36.62 | 4.94 | 1.00 | 223.12 | 0.223 | 0.277 | 6.70e-10 | 1.91e-11 | 13 |
| 96–111 | 2822.9 | 3979.6 | 8.75 | 43.31 | 7.00 | 1.00 | 234.00 | 2.035 | 0.001 | 8.94e-10 | 4.62e-11 | 0 |
| 112–127 | 8857.6 | 9999.5 | 7.12 | 40.06 | 5.50 | 145.50 | 34047.00 | 4.910 | 0.001 | 4.57e-10 | 8.99e-12 | 0 |
| 128–143 | 9194.7 | 10266.6 | 9.56 | 49.00 | 7.88 | 159.81 | 37396.12 | 7.693 | 0.003 | 5.45e-10 | 2.64e-11 | 0 |
| 144–159 | 2682.3 | 4803.0 | 8.81 | 46.38 | 7.50 | 1.00 | 234.00 | 10.056 | 0.303 | 7.50e-10 | 3.62e-11 | 0 |

## Cadence sensitivity

| cadence | ticks | root RMS cm | foot RMS cm | hand RMS cm |
|---|---:|---:|---:|---:|
| 1.00x | 160 | 4.343 | 0.246 | 25.957 |
