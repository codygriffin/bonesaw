...
|---:|---|---:|---:|:---:|:---:|:---:|---:|---:|---:|
| 0 | double | 0.000 | 0.000 | `11` | `00` | `00` | 1 | 2.501e-14 | 163.3 |
| 1 | double | 0.000 | 0.000 | `11` | `00` | `00` | 1 | 2.833e-14 | 155.5 |
| 2 | double | 0.000 | 0.000 | `11` | `11` | `11` | 0 | 1.343e-12 | 176.1 |
| 3 | left_only | -0.080 | 0.012 | `10` | `11` | `10` | 1 | 1.672e-12 | 166.8 |
| 4 | left_only | -0.080 | 0.012 | `10` | `10` | `10` | 1 | 1.672e-12 | 166.3 |
| 5 | right_only | 0.080 | 0.012 | `01` | `10` | `00` | 1 | 9.932e-14 | 161.6 |
| 6 | right_only | 0.080 | 0.012 | `01` | `00` | `00` | 1 | 9.932e-14 | 154.3 |
| 7 | right_only | 0.080 | 0.012 | `01` | `01` | `01` | 1 | 4.207e-12 | 164.8 |
| 8 | flight | 0.000 | 0.500 | `00` | `01` | `00` | 1 | 3.680e-14 | 117.5 |
| 9 | flight | 0.000 | 0.500 | `00` | `00` | `00` | 1 | 3.680e-14 | 116.0 |
