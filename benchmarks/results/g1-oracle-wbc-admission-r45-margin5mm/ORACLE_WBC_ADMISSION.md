...
|---|---:|---:|---:|---:|---:|---:|
| Rust whole-body IK witness | 600/600 converged | foot 4.99 mm · CoM 27.28 mm | 1.3 µs | 19.3 µs | 36.3 µs | 0 calls / 0 B |
| Rust analytic jet projection | authored residual: foot v 0.17% · a 12.96% · CoM v 7.69% · a 25.54% | analytic Jv / Jq̈+J̇v | 28.0 µs | 36.2 µs | 37.0 µs | 0 calls / 0 B |
| Stateless floating WBC | 600/600 solved | dynamics 1.22e-09 · contact 4.88e-11 · CoP margin 0.500 cm | 2419.8 µs | 3747.5 µs | 4371.7 µs | 0 calls / 0 B |
...
- PASS `wbc_cop_respects_1cm_eroded_support`
