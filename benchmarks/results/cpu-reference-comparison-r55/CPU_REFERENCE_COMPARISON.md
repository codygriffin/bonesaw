# Bonesaw CPU reference comparison · r55
...
> Timing is host- and run-specific. The G1 r54 measurements are current; PlaCo, Pinocchio, and Upkie are retained r38 measurements on the same recorded host and are checksum-addressed below. This report performs no retiming and makes no cross-boundary speedup claim.
...
## PlaCo fixed-base task comparison (retained r38)

| scenario | impl | RMS / steady cm | IAE / ISE | p50 / p99 / max µs | jitter p99 µs | steps/s | peak / Δ RSS MiB | GC |
|---|---|---|---|---|---|---|---|---|
| end_effector_reach | Bonesaw | 0.630 / 0.129 | 0.3042 / 0.0079 | 39.4 / 52.8 / 70.6 | 9.0 | 24770 | 43.34 / 1.37 | 0 |
| end_effector_reach | PlaCo | 0.809 / 0.737 | 1.4943 / 0.0131 | 95.2 / 170.4 / 246.8 | 59.8 | 9427 | 95.95 / 0.27 | 0 |
| bimanual_priority_conflict | Bonesaw | 0.475 / 0.000 | 0.0431 / 0.0045 | 87.6 / 102.8 / 140.5 | 16.0 | 11345 | 47.46 / 1.37 | 0 |
| bimanual_priority_conflict | PlaCo | 0.365 / 0.252 | 0.5146 / 0.0027 | 108.3 / 124.8 / 252.3 | 18.1 | 8637 | 99.72 / 0.26 | 0 |
| walking_motion_retarget | Bonesaw | 4.048 / 4.062 | 11.0005 / 0.6555 | 63.1 / 72.3 / 239.4 | 13.1 | 15811 | 49.87 / 1.37 | 0 |
| walking_motion_retarget | PlaCo | 2.634 / 2.645 | 5.2549 / 0.2776 | 132.3 / 159.3 / 335.5 | 24.5 | 7097 | 102.35 / 0.50 | 0 |

PlaCo tracks the walking endpoints better on this fixed-pelvis toy corpus; Bonesaw is faster and reaches lower steady error on the reach/conflict cases. Both walking gates in the retained report fail a predeclared sub-gate (Bonesaw foot RMS; PlaCo clearance RMS). The current G1 result above is a different, floating inverse-dynamics admission boundary and is not used to erase that historical failure.

## Pinocchio rigid-body product oracle (retained r38)
...
## Upkie upstream controller oracle (retained r38)
...
| p50 / p99 / max latency µs | 1.393 / 2.314 / 20.058 | 0.030 / 0.031 / 10.440 | C++ includes Dictionary I/O; Rust is typed call |
| jitter p99 µs | 0.371 | 0.011 | boundary cost differs |
| peak RSS MiB | 8.66 | 8.47 | isolated workers |
...
- PlaCo timing is retained and independently useful, but a fresh same-session rerun is required before publishing speed ratios.
...
| benchmarks/results/reference-r38/reference-metrics.json | 5547206e939b5ce4bfbb77d21aef710acf254f4db0dc1521d46bc9a5ba3119e1 |
| benchmarks/results/reference-r38/bonesaw-raw.npz | 89904f54dd9b09e19f1e1a72ab56606c8357dcd93b55616772bea41ce438620f |
| benchmarks/results/reference-r38/placo-raw.npz | 51b2982c7c0d47e814623d7fc028e10843a93c74282ca222053b826eaf5a37ce |
| benchmarks/results/reference-r38/upkie-controller-raw.npz | 7860abc814c989a127919a9c9071642cdccede291307f3b5bf23b799c1a5bf68 |
