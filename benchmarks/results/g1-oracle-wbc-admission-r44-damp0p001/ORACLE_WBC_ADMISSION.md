...
|---|---:|---:|---:|---:|---:|---:|
| Rust whole-body IK witness | 600/600 converged | foot 4.99 mm · CoM 27.28 mm | 1.4 µs | 19.6 µs | 36.8 µs | 0 calls / 0 B |
| Stateless floating WBC | 600/600 solved | dynamics 1.21e-09 · contact 4.65e-11 | 2536.9 µs | 6360.5 µs | 8822.3 µs | 0 calls / 0 B |

The maximum viability-task RMS is `9.736089` in physical acceleration/momentum-rate units; the maximum joint-witness speed/acceleration is `4.248 rad/s` / `111.006 rad/s²`. Physical WBC outputs are bitwise repeatable: `True`.
