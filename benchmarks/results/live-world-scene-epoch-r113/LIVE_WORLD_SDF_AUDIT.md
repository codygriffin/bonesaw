# Bonesaw live versioned-scene + robust world-SDF authority · r113

## Outcome

**PASS.** The r113 WebSocket contract retains the local world-SDF Viability row and separately exposes scene epoch/freshness, floating-root prediction, deterministic forecast-error erosion, sampled command-world geometry, and continuous certification across 60 guided 50 Hz frames during an 80.0 mm vertical torso disturbance. Scene epoch [113] remained `valid` and covered every 20 ms command horizon. This is a state-local authority query plus policy-/physics-free command admission, not a map-frame jump, policy, simulator, probability claim, or plant rollout.
...
| raw WBC p50 / p99 / max | 1.912 / 2.927 / 3.070 ms |
| command admission p50 / p99 / max | 1.429 / 2.350 / 2.522 ms |
...
| world scene epoch / validity | [113] / {"valid": 60} |
