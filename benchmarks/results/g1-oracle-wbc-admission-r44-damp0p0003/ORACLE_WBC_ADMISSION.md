...
|---|---:|---:|---:|---:|---:|---:|
| Rust whole-body IK witness | 600/600 converged | foot 4.99 mm · CoM 27.28 mm | 1.8 µs | 28.7 µs | 54.1 µs | 0 calls / 0 B |
| Stateless floating WBC | 600/600 solved | dynamics 1.21e-09 · contact 4.65e-11 | 2516.8 µs | 6398.1 µs | 6778.5 µs | 0 calls / 0 B |

The maximum viability-task RMS is `11.045574` in physical acceleration/momentum-rate units; the maximum joint-witness speed/acceleration is `4.387 rad/s` / `125.100 rad/s²`. Physical WBC outputs are bitwise repeatable: `True`.
