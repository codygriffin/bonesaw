...
|---|---:|---:|---:|---:|---:|---:|
| Rust whole-body IK witness | 95/600 converged | foot 1300.31 mm · CoM 153.45 mm | 806.2 µs | 839.6 µs | 1623.2 µs | 0 calls / 0 B |
| Stateless floating WBC | 466/600 solved | dynamics 1.21e+05 · contact 6.89e+02 | 2480.0 µs | 210723.7 µs | 307302.7 µs | 0 calls / 0 B |

The maximum viability-task RMS is `2480.651525` in physical acceleration/momentum-rate units; the maximum joint-witness speed/acceleration is `362.804 rad/s` / `5055931.034 rad/s²`. Physical WBC outputs are bitwise repeatable: `True`.

## Predeclared gates

- PASS `reference_inputs_remain_bitwise_immutable`
- FAIL `all_kinematic_witness_ticks_converge`
- FAIL `kinematic_point_error_le_1cm`
- FAIL `kinematic_com_error_le_3cm`
- FAIL `kinematic_joint_velocity_le_8rad_s`
- FAIL `kinematic_joint_acceleration_le_200rad_s2`
- PASS `kinematic_hot_loop_has_zero_allocations`
- PASS `kinematic_jet_hot_loop_has_zero_allocations`
- PASS `kinematic_point_velocity_residual_le_1mm_s`
- FAIL `kinematic_point_acceleration_residual_le_1cm_s2`
- FAIL `kinematic_orientation_error_le_0_1deg`
- PASS `kinematic_angular_velocity_residual_le_1mrad_s`
- FAIL `kinematic_angular_acceleration_residual_le_1e_2rad_s2`
- FAIL `no_wbc_infeasible_or_failed_ticks`
- FAIL `wbc_dynamics_residual_le_1e_8`
- FAIL `wbc_contact_residual_le_1e_8`
- PASS `wbc_friction_margin_nonnegative`
- PASS `wbc_torque_margin_nonnegative`
- FAIL `wbc_viability_task_rms_le_0_1`
- FAIL `wbc_p99_latency_le_20ms`
