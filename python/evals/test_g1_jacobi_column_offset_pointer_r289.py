...
RESULT = (
    ROOT
    / "benchmarks/results/g1-jacobi-column-offset-pointer-r289"
    / "g1-jacobi-column-offset-pointer-r289-metrics.json"
)


class JacobiColumnOffsetPointerR289Test(unittest.TestCase):
